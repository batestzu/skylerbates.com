...
export default function TheHighlanderPage() {
  const [step, setStep] = useState<Step>("form");
  const [errorMsg, setErrorMsg] = useState("");
  const [formData, setFormData] = useState({
    opportunity: "The Highlander",
    name: "",
    groupName: "",
    email: "",
    phone: "",
  ...
  return (
    <div className="pt-32 pb-24 min-h-screen">
      <div className="max-w-3xl mx-auto px-6">
        ...
        >
          The Highlander: A British Pub is a pub in North Augusta, SC. Musical Performances occur on
          Friday Nights. Groups can choose between 9pm–Midnight or 10pm–1am. Pay is $150 for solo
          acts &amp; $200 for Groups. Free Yuengling! The Highlander is a fun place where you can
          cut loose and turn up a bit. We are excited for your interest. Cheers!
        </motion.p>
        ...
        {step === "success" ? (
          ...
          >
            ...
            <p className="text-sm text-[#F5F0EB]/50 font-[family-name:var(--font-inter)] max-w-sm mx-auto">
              Cheers! We&apos;ll be in touch soon. Looking forward to having you at The Highlander.
            </p>
          </motion.div>
        ) : (
          <motion.form
          ...
          >
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              <div>
                ...
                >
                  ...
                  <option value="Group" className="bg-[#0e0a0c]">Group</option>
                </select>
              </div>
            </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="PA, monitors, mic stand…"
                className={inputClass}
              />
            </div>
            ...
            <div>
              ...
              <input
                ...
                placeholder="Yuengling, water, red bull…"
                className={inputClass}
              />
            </div>
