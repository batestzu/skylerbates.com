...
export default function CrownePlazaPage() {
  const [step, setStep] = useState<Step>("form");
  const [errorMsg, setErrorMsg] = useState("");
  const [formData, setFormData] = useState({
    opportunity: "Crowne Plaza",
    name: "",
    groupName: "",
    email: "",
    phone: "",
  ...
  return (
    <div className="pt-32 pb-24 min-h-screen">
      <div className="max-w-3xl mx-auto px-6">
        ...
        >
          The Crowne Plaza is an upscale hotel in the heart of North Augusta&apos;s Riverside
          Village. We host live entertainment for guests and locals alike — from laid-back
          acoustic sets to DJs and jazz trios. If you feel this is you please fill out a form
        ...
        {step === "success" ? (
          ...
          >
            ...
            <p className="text-sm text-[#F5F0EB]/50 font-[family-name:var(--font-inter)] max-w-sm mx-auto">
              Thank you for your interest in the Crowne Plaza. We&apos;ll be in touch soon.
            </p>
          </motion.div>
        ) : (
          <motion.form
            ...
            <div className="grid sm:grid-cols-2 gap-6">
              <div>
                ...
                >
                  ...
                  <option value="Dj" className="bg-[#0e0a0c]">Dj</option>
                  <option value="Jazz Trio" className="bg-[#0e0a0c]">Jazz Trio</option>
                </select>
              </div>
            </div>
